import {fgsData} from './state_india.js';
import {coarseData} from './coarse_india.js';
import {fineData} from './fine_india.js';
import {stateStats} from './data/state_indiastats.js';
import {coarseStats} from './data/coarse_indiastats.js';
import {fineStats} from './data/fine_indiastats.js';
...
import {timeslider, cleanDate} from './timeSlider.js';
	...
	var poly_layers = {};
	poly_layers["state"] = L.layerGroup().addTo( map ); //This one is active
	...
	var polygonData = { "state" : fgsData, "coarse" : coarseData, "fine" : fineData }


	//Set defaults
	var active_number = "stats";
	var active_polys = "state";
	
	//data containers
	var geojson = {}; //Layer manager
	var tweetInfo = {}; //Input Data
	var grid_sizes = {"state":"county",  "coarse":"15", "fine":"40"}
	var processedTweetInfo = { "state" : {"stats" : {}, "count" : {}, "embed" : {}},
	...
	var default_max = -72*60 + 1;
	
	//stats stuff
	var B = 1428; //number of stats days
	var statsData = {"state":stateStats, "coarse":coarseStats, "fine":fineStats}; 
